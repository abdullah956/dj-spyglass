...
from .views import agent_invites_for_assistant,all_homeowners_for_assistant,assistant_send_connection_request_homeowner,homeowner_requests_status_by_assistant
...
urlpatterns = [
    ...
    path('all-homeowners-for_-assistant/', all_homeowners_for_assistant, name='all_homeowners_for_assistant'),
