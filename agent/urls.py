...
from .views import assistant_update_request_status,agent_home_view,connection_requests_view,update_request_status,property_approval_list,property_approve, assistant_connection_requests_view
